...
export declare const base64EncodeCompositeKey: (key: Record<string, any>) => string;
export declare const base64DecodeCompositeKey: (value: string) => Record<string, any>;
